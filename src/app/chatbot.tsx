...
export default function ChatBot() {
    return (
        <SafeAreaView style={styles.container}>
            <View style={{ width: "100%", marginBottom: 10, zIndex: 10 }}>
                <HeaderBack />
            </View>
            ...
            <View style={styles.int}>
                <View style={styles.logo}>
                    <MaterialCommunityIcons name="robot" size={30} color="white" style={styles.icon}/>
                </View>
            ...
            <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingBottom: 24, paddingTop: 10 }}>
                <View style={styles.chat}>
                    <View style={styles.ia}>
                        <Text style={{lineHeight: 20}}>Olá! Como posso ajudar você a otimizar sua vida financeira hoje? Você pode me perguntar sobre seu saldo, novas oportunidades de investimento ou análise de gastos.</Text>
                    </View>
                    <Text style={styles.time1}>10:24 AM</Text>

                    <View style={styles.user}>
                        <Text style={{color: "white", lineHeight: 20}}>Gostaria de ver um resumo dos meus investimentos este mês</Text>
                    </View>
                    <Text style={styles.time2}>10:24 AM</Text>

                    <View style={styles.ia}>
                        <Text style={{lineHeight: 20}}>Com certeza. Seu portfólio teve uma valorização de <Text style={styles.dado}>+4.2%</Text> nos últimos 30 dias. Veja o Destaque:</Text>
                    </View>
                    <Text style={styles.time1}>10:24 AM</Text>
