      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        <View style={styles.main}>
          ...
          <Text style={styles.text2}>
            Gerencie seus compromissos financeiros recorrentes.
          </Text>
        ...
        <View style={styles.verTodosContainer}>
          <TouchableOpacity
            ...
            onPress={() =>
              router.push("/detailshome/lembretes/vertodoslembretes" as any)
            }
          >
        ...
        <View style={styles.containerExtra}>
          ...
          <Text style={styles.text5}>
            Automatize o acompanhamento de suas contas recorrentes.
          </Text>
          <Link href="/detailshome/lembretes/createLembrete/page" asChild>
...
const styles = StyleSheet.create({
  ...
  badgeTextPago: { color: "#475569", fontSize: 10, fontWeight: "700" },
